  ...
  const examQuestions: Question[] = [
    {
      ...
      correctAnswer: 2,
      explanation: "Effort is the force applied to a simple machine to do work. It's the input force that overcomes the load.",
    ...
    },
    {
      ...
      correctAnswer: 2,
      explanation: "In longitudinal waves (like sound), particle vibration is parallel to wave direction. In transverse waves (like string waves), particle vibration is perpendicular to wave direction.",
      topic: "Waves",
      difficulty: "Medium"
    },
    {
      ...
      correctAnswer: 1,
      explanation: "Apparent weight = Actual weight - Buoyant force. The buoyant force reduces the apparent weight in fluid.",
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation: "AMA = Load/Effort. For constant velocity on inclined plane: Effort = mg(sinθ + μ cosθ), so AMA = 1/(sinθ + μ cosθ)",
      topic: "Simple Machines",
      difficulty: "Hard"
    },
    {
      ...
      correctAnswer: 0,
      explanation: "Load = 6kg × 10m/s² = 60N. Efficiency = (Load × Load distance)/(Effort × Effort distance) × 100% = (60N × 0.08m)/(20N × 0.40m) × 100% = 4.8/8 × 100% = 60%",
      topic: "Simple Machines",
      difficulty: "Medium"
    },
    {
      ...
      correctAnswer: 3,
      explanation: "Using conservation of momentum: m₁u₁ + m₂u₂ = m₁v₁ + m₂v₂ → 8×6 + 12×3 = 8×4 + 12×v₂ → 48 + 36 = 32 + 12v₂ → 84 = 32 + 12v₂ → 12v₂ = 52 → v₂ = 4.33 m/s",
      topic: "Momentum",
      difficulty: "Medium"
    },
    {
      ...
      correctAnswer: 1,
      explanation: "According to right-hand rule, magnetic field forms concentric circles around a straight current-carrying wire.",
      topic: "Magnetism",
      difficulty: "Easy"
    },
    {
      ...
      correctAnswer: 0,
      explanation: "Group III elements (like Boron) have 3 valence electrons. When doped into silicon (4 valence electrons), they create 'holes' making it P-type semiconductor.",
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation: "Plastic is an insulator because electrons are tightly bound to atoms, preventing free electron movement and current flow.",
      topic: "Electricity",
      difficulty: "Easy"
    },
    {
      ...
      correctAnswer: 2,
      explanation: "Faraday's law: ε = -dΦ/dt = -B·dA/dt. Magnitude: ε = 0.50 × (4×10⁻³)/2 = 1.0 × 10⁻³ V",
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation: "Vectors have both magnitude and direction (e.g., force, velocity). Scalars have only magnitude.",
      topic: "Vectors",
      difficulty: "Easy"
    },
    {
      ...
      correctAnswer: 2,
      explanation: "Newton's first law: An object in motion stays in motion with constant velocity unless acted upon by a net external force.",
      topic: "Newton's Laws",
      difficulty: "Easy"
    },
    {
      ...
      correctAnswer: 3,
      explanation: "Distance is total path length (scalar), displacement is straight-line distance from start to end (vector). Distance ≥ |Displacement|.",
      topic: "Kinematics",
      difficulty: "Easy"
    },
    {
      ...
      correctAnswer: 0,
      explanation: "Uniform acceleration means constant acceleration. Velocity changes uniformly with time.",
      topic: "Kinematics",
      difficulty: "Easy"
    },
    {
      ...
      correctAnswer: 2,
      explanation: "Maximum resultant = 4 + 3 = 7m (when parallel), minimum = 4 - 3 = 1m (when anti-parallel). 12m is impossible.",
      topic: "Vectors",
      difficulty: "Medium"
    },
    {
      ...
      correctAnswer: 3,
      explanation: "Using v = u + at: 30 = u + 5×4 → u = 10 m/s. Then s = ut + ½at² = 10×8 + ½×5×64 = 80 + 160 = 240 m",
      topic: "Kinematics",
      difficulty: "Medium"
    },
    {
      ...
      correctAnswer: 2,
      explanation: "Linear equilibrium requires zero acceleration (Newton's first law: ΣF = 0 → a = 0).",
      topic: "Dynamics",
      difficulty: "Easy"
    },
    {
      ...
      correctAnswer: 0,
      explanation: "Surface irregularities cause mechanical interlocking, resulting in frictional force.",
      topic: "Friction",
      difficulty: "Easy"
    },
    {
      ...
      correctAnswer: 1,
      explanation: "Gravity does positive work when object moves in direction of gravitational force (downward). W = F·d = mg·h (positive when moving down).",
    ...
    },
    {
      ...
      correctAnswer: 3,
      explanation: "Mechanical energy = Kinetic energy + Potential energy. In conservative systems, this total remains constant.",
      topic: "Energy",
      difficulty: "Easy"
    },
    {
      ...
      correctAnswer: 0,
      explanation: "F_net = ma = 2×1.5 = 3N to the right. F₁ - F₂ = 3N → F₁ - 1 = 3 → F₁ = 4N",
      topic: "Dynamics",
      difficulty: "Medium"
    },
    {
      ...
      correctAnswer: 1,
      explanation: "Impulse = mΔv = 0.10 × (40 - (-30)) = 0.10 × 70 = 7.0 kg m/s (direction change gives larger Δv)",
      topic: "Momentum",
      difficulty: "Medium"
    },
    {
      ...
      correctAnswer: 0,
      explanation: "Flow rate = Volume/time (m³/s). Mass flow rate = mass/time, velocity is speed of flow.",
      topic: "Fluid Mechanics",
      difficulty: "Easy"
    },
    {
      ...
      correctAnswer: 1,
      explanation: "Solid atoms are closely packed in fixed positions with strong bonds, making compression difficult.",
    ...
    },
    {
      ...
      correctAnswer: 3,
      explanation: "Magnetic poles always come in pairs (dipoles). Cutting a magnet creates two smaller magnets, each with N and S poles.",
      topic: "Magnetism",
      difficulty: "Easy"
    },
    {
    ...
    },
    {
      ...
      correctAnswer: 2,
      explanation: "F = Gm₁m₂/r² = (6.67×10⁻¹¹ × 50 × 55) / 4 = (6.67×10⁻¹¹ × 2750) / 4 = 4.6 × 10⁻⁸ N",
      topic: "Gravitation",
      difficulty: "Medium"
    },
    {
      ...
      correctAnswer: 3,
      explanation: "Pascal's principle: F₁/A₁ = F₂/A₂ → A₂ = F₂A₁/F₁ = 2500 × π(0.1)² / 10 = 2500 × 0.0314 / 10 = 7.85 m²",
      topic: "Fluid Mechanics",
      difficulty: "Medium"
    },
    {
    ...
    },
    {
      ...
      correctAnswer: 0,
      explanation: "Sound travels faster in solids > liquids > gases. In same medium, it's faster in colder, less dense conditions.",
      topic: "Sound Waves",
      difficulty: "Medium"
    },
    {
      ...
      correctAnswer: 2,
      explanation: "Typically R₃ and R₄ are in parallel, and this combination is in series with R₁.",
      topic: "Circuits",
      difficulty: "Medium"
    },
    {
    ...
    },
    {
      ...
      correctAnswer: 0,
      explanation: "B = μ₀I/(2πr) = (4π×10⁻⁷ × 5) / (2π×0.02) = (20π×10⁻⁷) / (0.04π) = 5×10⁻⁵ T",
      topic: "Magnetism",
      difficulty: "Medium"
    },
    {
      ...
      correctAnswer: 3,
      explanation: "Scalar (dot) product = a·b = ab cos α. Vector (cross) product = ab sin α.",
      topic: "Vectors",
      difficulty: "Easy"
    },
    {
      ...
      correctAnswer: 0,
      explanation: "Real images form when light rays actually converge, so they can be projected on screens. Virtual images cannot.",
      topic: "Optics",
      difficulty: "Easy"
    },
    {
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation: "|A| = √(3² + (-4)²) = 5. Unit vector = A/|A| = (3î - 4ĵ)/5 = 0.6î - 0.8ĵ",
      topic: "Vectors",
      difficulty: "Easy"
    },
    {
      ...
      correctAnswer: 0,
      explanation: "Resultant magnitude ≈ 125 N, so length = 125/10 = 12.5 cm. Direction mainly northward due to similar angles.",
      topic: "Vectors",
      difficulty: "Hard"
    },
    {
      ...
      correctAnswer: 1,
      explanation: "Mechanical engineering focuses on dynamics (motion), thermodynamics (heat), forces, and stress analysis.",
    ...
    },
    {
      ...
      correctAnswer: 2,
      explanation: "Infrared devices detect thermal radiation (heat signatures) from objects.",
      topic: "Applied Physics",
      difficulty: "Medium"
    },
    {
      ...
      correctAnswer: 3,
      explanation: "During vaporization (liquid to gas), latent heat is absorbed at constant temperature.",
    ...
    },
    {
      ...
      correctAnswer: 0,
      explanation: "Horizontal acceleration is zero (no horizontal forces). Vertical acceleration is g due to gravity.",
    ...
    },
    {
      ...
      correctAnswer: 2,
      explanation: "H = (v₀² sin²θ)/(2g), R = (v₀² sin 2θ)/g = (2v₀² sinθ cosθ)/g = 4H/tan θ",
      topic: "Projectile Motion",
      difficulty: "Hard"
    },
    {
      ...
      correctAnswer: 1,
      explanation: "Assuming positions: m₁ at 1m, m₂ at 2m, m₃ at 3m, m₄ at 4m. I = Σmᵢrᵢ² = 4×1² + 1×2² + 3×3² + 5×4² = 4 + 4 + 27 + 80 = 115 kgm²",
      topic: "Rotational Motion",
      difficulty: "Hard"
    },
    {
      ...
      correctAnswer: 3,
      explanation: "Heat capacity = Q/ΔT (heat required per degree temperature change). Specific heat capacity is per unit mass.",
      topic: "Thermodynamics",
      difficulty: "Easy"
    },
    {
      ...
      correctAnswer: 1,
      explanation: "Diffraction is more noticeable when gap size ≈ wavelength. Narrow gaps show more diffraction.",
      topic: "Waves",
      difficulty: "Medium"
    },
    {
      ...
      correctAnswer: 0,
      explanation: "Area expansion coefficient = 2α (each dimension expands by αΔT, so area expands by 2αΔT)",
    ...
    },
    {
      ...
      correctAnswer: 2,
      explanation: "P_absolute = P_atm + ρgh = 1×10⁵ + 1030×10×100 = 1×10⁵ + 1.03×10⁶ = 1.13×10⁶ Pa",
      topic: "Fluid Mechanics",
      difficulty: "Medium"
    },
    {
      ...
      correctAnswer: 1,
      explanation: "h = P/(ρg) = 103360/(13600×10) = 103360/136000 = 0.76 m = 76 cm",
      topic: "Fluid Mechanics",
      difficulty: "Medium"
    },
    {
      ...
      correctAnswer: 3,
      explanation: "Q = mc_iceΔT + mL_f + mc_waterΔT = 5×2100×20 + 5×336000 + 5×4200×10 = 210,000 + 1,680,000 + 210,000 = 1,890,000 J",
      topic: "Thermodynamics",
      difficulty: "Hard"
    },
    {
      ...
      correctAnswer: 0,
      explanation: "Horizontal component T sin θ provides centripetal force. Vertical component T cos θ balances weight mg.",
    ...
    },
    {
      ...
      correctAnswer: 0,
      explanation: "Displacement = area under v-t graph = ½×4×12 + 4×12 + ½×2×12 + 2×(-6) + ½×2×(-6) = 24 + 48 + 12 - 12 - 6 = 102 m",
      topic: "Kinematics",
      difficulty: "Hard"
    },
    {
      ...
      correctAnswer: 1,
      explanation: "Work = mgh = 10000×10×20 = 2×10⁶ J. Time = Work/Power = 2×10⁶/50000 = 40 s",
    ...
    },
    {
      ...
      correctAnswer: 3,
      explanation: "x_cm = (4×0 + 4×30 + 5×(-40) + 3×0)/16 = (0 + 120 - 200 + 0)/16 = -80/16 = -5 cm. y_cm = (4×0 + 4×0 + 5×0 + 3×20)/16 = 60/16 = 3.75 cm",
      topic: "Center of Mass",
      difficulty: "Medium"
    },
    {
      id: 59,
      question: "A spring stores 120 J of elastic potential energy when it is stretched by 0.5 m. What is the spring constant?",
      options: ["480 N/m", "960 N/m", "1080 N/m", "540 N/m"],
      correctAnswer: 1,
      explanation: "PE = ½kx² → 120 = ½k(0.5)² → 120 = ½k(0.25) → k = 120 × 2 / 0.25 = 960 N/m",
      topic: "Energy",
      difficulty: "Medium"
    },
    {
      id: 60,
      question: "What is the efficiency of a heat engine that absorbs 2000 J of heat and performs 600 J of work?",
      options: ["30%", "40%", "50%", "60%"],
      correctAnswer: 0,
      explanation: "Efficiency = Work output/Heat input × 100% = 600/2000 × 100% = 30%",
      topic: "Thermodynamics",
      difficulty: "Easy"
    }
  ];
              ...
              <div className="mb-8">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className={`font-semibold ${
                          userAnswer === currentQ.correctAnswer ? 'text-green-800' : 'text-red-800'
                        }`}>
                ...
                <div className="space-y-3">
                  {currentQ.options.map((option, index) => {
                    ...
                    const showAsCorrect = showAnswers && isAnswered && isCorrect;
                    const showAsWrong = showAnswers && isAnswered && isSelected && !isCorrect;
                    ...
                    return (
                      <motion.button
                        ...
                        } ${showAnswers && isAnswered ? 'cursor-default' : 'cursor-pointer'}`}
                      >
                        <div className="flex items-center gap-3">
                          <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center ${
                            ...
                            {showAsCorrect && <CheckCircle className="w-3 h-3 absolute" />}
                            {showAsWrong && <XCircle className="w-3 h-3 absolute" />}
                          </div>
                          <span className={`${
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <ul className="text-yellow-700 text-sm space-y-1">
                    ...
                    <li>• Toggle 'Show Answers' to see correct answers after answering</li>
