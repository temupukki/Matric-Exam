                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      },
                      {
                        ...
                        description: "Daily study schedule reminders",
                        enabled: false,
                      },
                      {
                        label: "Test Results",
                      ...
                      >
                        ...
                        >
                          <div
                            className={`w-6 h-6 bg-white rounded-full absolute top-0 shadow-md transform transition-transform ${
                              setting.enabled ? "right-0" : "left-0"
                            }`}
                          />
                        </div>
                      </div>
