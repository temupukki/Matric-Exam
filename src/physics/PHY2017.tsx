  ...
  const examQuestions: Question[] = [
    {
      ...
      correctAnswer: 2,
      explanation:
        "Effort is the force applied to a simple machine to do work. It's the input force that overcomes the load.",
    ...
    },
    {
      ...
      correctAnswer: 2,
      explanation:
        "In longitudinal waves (like sound), particle vibration is parallel to wave direction. In transverse waves (like string waves), particle vibration is perpendicular to wave direction.",
      topic: "Waves",
    },
    {
      id: 3,
      ...
      correctAnswer: 1,
      explanation:
        "Apparent weight = Actual weight - Buoyant force. The buoyant force reduces the apparent weight in fluid.",
      topic: "Fluid Mechanics",
    },
    {
      id: 4,
      question:
        "A force is used to push a box of mass, m along the slope of inclined plane with constant velocity. If the coefficient of friction between the box and the inclined plane be μ, the actual mechanical advantage (AMA) of the inclined plane is",
      options: [
        "1/(cosθ + μ sinθ)",
        "1/(sinθ + μ cosθ)",
        "(cosθ + μ sinθ)",
      ...
      correctAnswer: 1,
      explanation:
        "AMA = Load/Effort. For constant velocity on inclined plane: Effort = mg(sinθ + μ cosθ), so AMA = 1/(sinθ + μ cosθ)",
      topic: "Simple Machines",
    },
    {
      id: 5,
      ...
      correctAnswer: 0,
      explanation:
        "Load = 6kg × 10m/s² = 60N. Efficiency = (Load × Load distance)/(Effort × Effort distance) × 100% = (60N × 0.08m)/(20N × 0.40m) × 100% = 4.8/8 × 100% = 60%",
      topic: "Simple Machines",
    },
    {
      id: 6,
      ...
      correctAnswer: 3,
      explanation:
        "Using conservation of momentum: m₁u₁ + m₂u₂ = m₁v₁ + m₂v₂ → 8×6 + 12×3 = 8×4 + 12×v₂ → 48 + 36 = 32 + 12v₂ → 84 = 32 + 12v₂ → 12v₂ = 52 → v₂ = 4.33 m/s",
      topic: "Momentum",
    },
    {
      id: 7,
      ...
      correctAnswer: 1,
      explanation:
        "According to right-hand rule, magnetic field forms concentric circles around a straight current-carrying wire.",
      topic: "Magnetism",
    },
    {
      id: 8,
      ...
      correctAnswer: 0,
      explanation:
        "Group III elements (like Boron) have 3 valence electrons. When doped into silicon (4 valence electrons), they create 'holes' making it P-type semiconductor.",
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        "Plastic is an insulator because electrons are tightly bound to atoms, preventing free electron movement and current flow.",
      topic: "Electricity",
    },
    {
      id: 10,
      ...
      correctAnswer: 2,
      explanation:
        "Faraday's law: ε = -dΦ/dt = -B·dA/dt. Magnitude: ε = 0.50 × (4×10⁻³)/2 = 1.0 × 10⁻³ V",
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        "Vectors have both magnitude and direction (e.g., force, velocity). Scalars have only magnitude.",
      topic: "Vectors",
    },
    {
      id: 12,
      ...
      correctAnswer: 2,
      explanation:
        "Newton's first law: An object in motion stays in motion with constant velocity unless acted upon by a net external force.",
      topic: "Newton's Laws",
    },
    {
      id: 13,
      ...
      correctAnswer: 3,
      explanation:
        "Distance is total path length (scalar), displacement is straight-line distance from start to end (vector). Distance ≥ |Displacement|.",
      topic: "Kinematics",
    },
    {
      id: 14,
      ...
      correctAnswer: 0,
      explanation:
        "Uniform acceleration means constant acceleration. Velocity changes uniformly with time.",
      topic: "Kinematics",
    },
    {
      id: 15,
      ...
      correctAnswer: 2,
      explanation:
        "Maximum resultant = 4 + 3 = 7m (when parallel), minimum = 4 - 3 = 1m (when anti-parallel). 12m is impossible.",
      topic: "Vectors",
    },
    {
      id: 16,
      ...
      correctAnswer: 3,
      explanation:
        "Using v = u + at: 30 = u + 5×4 → u = 10 m/s. Then s = ut + ½at² = 10×8 + ½×5×64 = 80 + 160 = 240 m",
      topic: "Kinematics",
    },
    {
      id: 17,
      ...
      correctAnswer: 2,
      explanation:
        "Linear equilibrium requires zero acceleration (Newton's first law: ΣF = 0 → a = 0).",
      topic: "Dynamics",
    },
    {
      id: 18,
      ...
      correctAnswer: 0,
      explanation:
        "Surface irregularities cause mechanical interlocking, resulting in frictional force.",
      topic: "Friction",
    },
    {
      id: 19,
      ...
      correctAnswer: 1,
      explanation:
        "Gravity does positive work when object moves in direction of gravitational force (downward). W = F·d = mg·h (positive when moving down).",
    ...
    },
    {
      ...
      correctAnswer: 3,
      explanation:
        "Mechanical energy = Kinetic energy + Potential energy. In conservative systems, this total remains constant.",
      topic: "Energy",
    },
    {
      id: 21,
      question:
        "A 2 kg object accelerates with 1.5 m/s² to the right on a horizontal frictionless surface under the action of two horizontal forces, F₁ and F₂ as shown in the figure. If F₂ = 1 N to the left, what should be the magnitude of F₁?",
      options: ["4 N", "3 N", "1 N", "2 N"],
      correctAnswer: 0,
      explanation:
        "F_net = ma = 2×1.5 = 3N to the right. F₁ - F₂ = 3N → F₁ - 1 = 3 → F₁ = 4N",
      topic: "Dynamics",
    },
    {
      id: 22,
      ...
      correctAnswer: 1,
      explanation:
        "Impulse = mΔv = 0.10 × (40 - (-30)) = 0.10 × 70 = 7.0 kg m/s (direction change gives larger Δv)",
      topic: "Momentum",
    },
    {
      id: 23,
      ...
      correctAnswer: 0,
      explanation:
        "Flow rate = Volume/time (m³/s). Mass flow rate = mass/time, velocity is speed of flow.",
      topic: "Fluid Mechanics",
    },
    {
      id: 24,
      ...
      correctAnswer: 1,
      explanation:
        "Solid atoms are closely packed in fixed positions with strong bonds, making compression difficult.",
    ...
    },
    {
      ...
      correctAnswer: 3,
      explanation:
        "Magnetic poles always come in pairs (dipoles). Cutting a magnet creates two smaller magnets, each with N and S poles.",
      topic: "Magnetism",
    },
    {
      id: 26,
      ...
      correctAnswer: 3,
      explanation: "v = rω = 0.5 m × 200 rad/s = 100 m/s",
    ...
    },
    {
      ...
      correctAnswer: 2,
      explanation:
        "F = Gm₁m₂/r² = (6.67×10⁻¹¹ × 50 × 55) / 4 = (6.67×10⁻¹¹ × 2750) / 4 = 4.6 × 10⁻⁸ N",
      topic: "Gravitation",
    },
    {
      id: 28,
      ...
      correctAnswer: 3,
      explanation:
        "Pascal's principle: F₁/A₁ = F₂/A₂ → A₂ = F₂A₁/F₁ = 2500 × π(0.1)² / 10 = 2500 × 0.0314 / 10 = 7.85 m²",
      topic: "Fluid Mechanics",
    },
    {
      id: 29,
      ...
      correctAnswer: 3,
      explanation: "Electric field exerts force on charged particles: F = qE",
    ...
    },
    {
      ...
      correctAnswer: 0,
      explanation:
        "Sound travels faster in solids > liquids > gases. In same medium, it's faster in colder, less dense conditions.",
      topic: "Sound Waves",
    },
    {
      id: 31,
      question:
        "Four resistors are connected to a voltage source as shown in the figure. Which one of the following is correct about the circuit?",
      options: [
      ...
      correctAnswer: 2,
      explanation:
        "Typically R₃ and R₄ are in parallel, and this combination is in series with R₁.",
      topic: "Circuits",
    },
    {
      id: 32,
    ...
    },
    {
      ...
      correctAnswer: 3,
      explanation: "R ∝ L/A. New R = 6 × (2)/(0.5) = 6 × 4 = 24 Ω",
      topic: "Electricity",
    },
    {
      id: 34,
      question:
        "A long straight wire carries a current of 5.0 A. What is the magnetic field strength produced by the current at a distance of 2.0 cm from the wire?",
      options: ["5π × 10⁻⁵ T", "20π × 10⁻⁵ T", "20 × 10⁻⁵ T", "5 × 10⁻⁵ T"],
      correctAnswer: 0,
      explanation:
        "B = μ₀I/(2πr) = (4π×10⁻⁷ × 5) / (2π×0.02) = (20π×10⁻⁷) / (0.04π) = 5×10⁻⁵ T",
      topic: "Magnetism",
    },
    {
      id: 35,
      ...
      correctAnswer: 3,
      explanation:
        "Scalar (dot) product = a·b = ab cos α. Vector (cross) product = ab sin α.",
      topic: "Vectors",
    },
    {
      id: 36,
      ...
      correctAnswer: 0,
      explanation:
        "Real images form when light rays actually converge, so they can be projected on screens. Virtual images cannot.",
      topic: "Optics",
    },
    {
      id: 37,
      question:
        "An object moving in one dimension with constant acceleration a travels through a displacement s in a time interval t. If its velocity at the initial time t = 0 is vᵢ and its velocity at a later time t is v_f, which of the following is a correct relation between the given quantities?",
      options: [
        "s = v_f t - ½ at²",
        "s = (v_f² - vᵢ²)/a",
        "s = vᵢ t + ½ at",
      ...
      correctAnswer: 1,
      explanation: "From v_f² = vᵢ² + 2as, we get s = (v_f² - vᵢ²)/a",
      topic: "Kinematics",
    },
    {
      id: 38,
      question:
        "If the critical angle for an optically denser medium to air boundary is 53° what will be the refractive index of the medium?",
    ...
    },
    {
      id: 39,
      question:
        "Given the displacement vector A = (3î - 4ĵ) m, what is the unit vector in the direction of A?",
      options: ["-0.6î + 0.8ĵ", "0.6î - 0.8ĵ", "0.8î - 0.6ĵ", "0.6î + 0.8ĵ"],
      correctAnswer: 1,
      explanation:
        "|A| = √(3² + (-4)²) = 5. Unit vector = A/|A| = (3î - 4ĵ)/5 = 0.6î - 0.8ĵ",
      topic: "Vectors",
    },
    {
      id: 40,
      ...
      correctAnswer: 0,
      explanation:
        "Resultant magnitude ≈ 125 N, so length = 125/10 = 12.5 cm. Direction mainly northward due to similar angles.",
      topic: "Vectors",
    },
    {
      id: 41,
      ...
      correctAnswer: 1,
      explanation:
        "Mechanical engineering focuses on dynamics (motion), thermodynamics (heat), forces, and stress analysis.",
    ...
    },
    {
      ...
      correctAnswer: 2,
      explanation:
        "Infrared devices detect thermal radiation (heat signatures) from objects.",
      topic: "Applied Physics",
    },
    {
      id: 43,
      ...
      correctAnswer: 3,
      explanation:
        "During vaporization (liquid to gas), latent heat is absorbed at constant temperature.",
    ...
    },
    {
      ...
      correctAnswer: 0,
      explanation:
        "Horizontal acceleration is zero (no horizontal forces). Vertical acceleration is g due to gravity.",
      topic: "Projectile Motion",
    },
    {
      id: 45,
      question:
        "A projectile is thrown from a level ground with an initial velocity v₀ making an angle of θ above the horizontal. If the maximum height covered by the projectile is H, then what is the horizontal range of the projectile in terms of H and θ?",
      options: ["H/tan θ", "H tan θ/4", "4H/tan θ", "H/(4 tan θ)"],
      correctAnswer: 2,
      explanation:
        "H = (v₀² sin²θ)/(2g), R = (v₀² sin 2θ)/g = (2v₀² sinθ cosθ)/g = 4H/tan θ",
      topic: "Projectile Motion",
    },
    {
      id: 46,
      question:
        "Four point masses m₁ = 4 kg, m₂ = 1 kg, m₃ = 3 kg and m₄ = 5 kg are attached to a massless rod which lays on the x-axis. How much is the moment of inertia of the system about the y-axis?",
      options: ["187 kgm²", "184 kgm²", "190 kgm²", "84 kgm²"],
      correctAnswer: 1,
      explanation:
        "Assuming positions: m₁ at 1m, m₂ at 2m, m₃ at 3m, m₄ at 4m. I = Σmᵢrᵢ² = 4×1² + 1×2² + 3×3² + 5×4² = 4 + 4 + 27 + 80 = 115 kgm²",
      topic: "Rotational Motion",
    },
    {
      id: 47,
      ...
      correctAnswer: 3,
      explanation:
        "Heat capacity = Q/ΔT (heat required per degree temperature change). Specific heat capacity is per unit mass.",
      topic: "Thermodynamics",
    },
    {
      id: 48,
      ...
      correctAnswer: 1,
      explanation:
        "Diffraction is more noticeable when gap size ≈ wavelength. Narrow gaps show more diffraction.",
      topic: "Waves",
    },
    {
      id: 49,
      ...
      correctAnswer: 0,
      explanation:
        "Area expansion coefficient = 2α (each dimension expands by αΔT, so area expands by 2αΔT)",
      topic: "Thermal Expansion",
    },
    {
      id: 50,
      question:
        "An object dropped into a sea sinks to a depth of 100 m. Which of the following is correct about the pressure the object experiences?",
      options: [
      ...
      correctAnswer: 2,
      explanation:
        "P_absolute = P_atm + ρgh = 1×10⁵ + 1030×10×100 = 1×10⁵ + 1.03×10⁶ = 1.13×10⁶ Pa",
      topic: "Fluid Mechanics",
    },
    {
      id: 51,
      question:
        "The atmospheric pressure in a certain area is determined to be 103.36 kPa, using a mercury barometer. The height to which the mercury column rises is about",
      options: ["76 mm", "76 cm", "7.6 m", "760 cm"],
      correctAnswer: 1,
      explanation:
        "h = P/(ρg) = 103360/(13600×10) = 103360/136000 = 0.76 m = 76 cm",
      topic: "Fluid Mechanics",
    },
    {
      id: 52,
      question:
        "How much heat energy is required to change 5 kg of ice at -20°C to water at 10°C?",
      options: ["4.20 × 10⁵ J", "1.68 × 10⁶ J", "2.10 × 10⁶ J", "1.89 × 10⁶ J"],
      correctAnswer: 3,
      explanation:
        "Q = mc_iceΔT + mL_f + mc_waterΔT = 5×2100×20 + 5×336000 + 5×4200×10 = 210,000 + 1,680,000 + 210,000 = 1,890,000 J",
      topic: "Thermodynamics",
    },
    {
      id: 53,
      question:
        "Suppose a particle of mass m is tied to a string and then whirled around in a horizontal circle of radius r about the center O. If the string makes an angle of θ to the vertical while rotating, the component of the force that is responsible for the circular motion of the mass by providing the centripetal force is",
      options: ["T sin θ", "T cos θ", "mg sin θ", "mg cos θ"],
      correctAnswer: 0,
      explanation:
        "Horizontal component T sin θ provides centripetal force. Vertical component T cos θ balances weight mg.",
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation: "Gravity governs planetary orbits and celestial motion.",
    ...
    },
    {
      ...
      correctAnswer: 2,
      explanation: "PE ∝ x². PE = 120 × (1.5/0.5)² = 120 × 9 = 1080 J",
      topic: "Energy",
    },
    {
      id: 56,
      question:
        "The velocity-time graph of an object moving in a straight line is shown. What is the magnitude of the total displacement covered by the object in the time interval of 14 seconds?",
      options: ["102 m", "90 m", "54 m", "42 m"],
      correctAnswer: 0,
      explanation:
        "Displacement = area under v-t graph = ½×4×12 + 4×12 + ½×2×12 + 2×(-6) + ½×2×(-6) = 24 + 48 + 12 - 12 - 6 = 102 m",
      topic: "Kinematics",
    },
    {
      id: 57,
      question:
        "A crane at port is used to lift 10,000 kg object to a height of 20 m. If the power developed by the crane is 50,000 W, how long does it take to lift the object?",
      options: ["400 s", "40 s", "4 s", "2 s"],
      correctAnswer: 1,
      explanation:
        "Work = mgh = 10000×10×20 = 2×10⁶ J. Time = Work/Power = 2×10⁶/50000 = 40 s",
    ...
    },
    {
      ...
      correctAnswer: 3,
      explanation:
        "x_cm = (4×0 + 4×30 + 5×(-40) + 3×0)/16 = (0 + 120 - 200 + 0)/16 = -80/16 = -5 cm. y_cm = (4×0 + 4×0 + 5×0 + 3×20)/16 = 60/16 = 3.75 cm",
      topic: "Center of Mass",
    },
    {
      id: 59,
      question:
        "A spring stores 120 J of elastic potential energy when it is stretched by 0.5 m. What is the spring constant?",
      options: ["480 N/m", "960 N/m", "1080 N/m", "540 N/m"],
      correctAnswer: 1,
      explanation:
        "PE = ½kx² → 120 = ½k(0.5)² → 120 = ½k(0.25) → k = 120 × 2 / 0.25 = 960 N/m",
      topic: "Energy",
    },
    {
      id: 60,
      question:
        "What is the efficiency of a heat engine that absorbs 2000 J of heat and performs 600 J of work?",
      options: ["30%", "40%", "50%", "60%"],
      correctAnswer: 0,
      explanation:
        "Efficiency = Work output/Heat input × 100% = 600/2000 × 100% = 30%",
      topic: "Thermodynamics",
    },
  ];
          ...
          <div className="lg:col-span-3">
            ...
            >
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  >
                    <Flag
                      className={`w-4 h-4 ${
                        flagged.has(currentQuestion) ? "fill-current" : ""
                      }`}
                    />
              ...
              <div className="mb-8">
                ...
                {/* Answer Indicator - Only show if user has answered AND showAnswers is enabled */}
                {showAnswers && isAnswered && (
                  <motion.div
                ...
                <div className="space-y-3">
                  {currentQ.options.map((option, index) => {
                    ...
                    // Show correct/wrong highlighting only if:
                    // 1. User has answered AND showAnswers is enabled
                    // 2. This option is either selected or is the correct answer
                    const showAsCorrect =
                      showAnswers && isAnswered && isCorrect;
                    const showAsWrong =
                      showAnswers && isAnswered && isSelected && !isCorrect;
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          >
                            ...
                            {showAsCorrect && (
                              <CheckCircle className="w-3 h-3 absolute" />
                            )}
                            {showAsWrong && (
                              <XCircle className="w-3 h-3 absolute" />
                            )}
                          </div>
                          <span
                            className={`${
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <ul className="text-yellow-700 text-sm space-y-1">
                    ...
                    <li>
                      • Toggle 'Show Answers' to see correct answers after
                      answering
                    </li>
