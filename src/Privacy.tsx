  ...
  const policySections = [
    {
      ...
      content: `
        ...
        • Personal Information: Name and  email  when you register
      ...
      <section className="relative py-16 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          >
            ...
            >
              Last updated: October 27, 2024. We are committed to protecting
            ...
            >
              ...
              Effective date: October 27, 2024 • Version 2.1
            </motion.div>
          </motion.div>
        </div>
      </section>
          ...
          >
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed">
                At ExamMaster, we are committed to protecting your privacy and
                ensuring the security of your personal information. This Privacy
                Policy explains how we collect, use, disclose, and safeguard
                your information when you use our educational platform. By
                accessing or using ExamMaster, you agree to the terms of this
                Privacy Policy.
              </p>
            </motion.div>
